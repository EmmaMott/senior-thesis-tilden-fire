...
#e_h_sv <- ec.sv %>% filter(trt == "H") %>% mutate(PP = as.double(PP))
#e_c_sv <- ec.sv %>% filter(trt == "C")
...
# Figure 1: histograms of nonburned plot temps
```{r}
temp.sv |>
  filter(plot == "NB1") |>
  ggplot(aes(x = num))+
...
# Figure 2: histograms of burned control plot temps
...
# Figure 3: histogram of heated plot
